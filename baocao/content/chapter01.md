...
2. **Kiểm tra tình trạng (Availability Check):**
...
5. **Lưu trú & Sử dụng dịch vụ:** Khách check-in.
    - Trong quá trình ở, khách có thể sử dụng thêm dịch vụ (Ăn uống, Spa) $\to$ Ghi nhận vào chi tiết hóa đơn.
6. **Trả phòng & Quyết toán:** Khách check-out.
